...
{
	ASSERT(eaf_subscribe(TEST_SERVICE_S1, TEST_SERVICE_S1_EVT, _test_stackcall_s1_on_evt, NULL) == 0);
	return 0;
}
...
{
	ASSERT(eaf_subscribe(TEST_SERVICE_S2, TEST_SERVICE_S2_EVT, _test_stackcall_s2_on_evt, NULL) == 0);
	return 0;
}
